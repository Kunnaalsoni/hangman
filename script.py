...
class HangMan(object):
    ...
    words = """ant baboon buffalo bat bear talk camel cat clam cobra harsh kattu
crow deer dog donkey duck eagle ferrari fox frog goat hawk lion lizard maruti gym 
mole monkey moose mouse owl panda parrot pigeon python rabbit ram hanuman hangman
rat raven rhino salmon seal shark sheep skunk sloth snake spider swan tiger
toad trout turkey turtle whale wolf bmw mustang zebra""".split()
